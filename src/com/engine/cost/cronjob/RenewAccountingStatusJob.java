package com.engine.cost.cronjob;
...
public class RenewAccountingStatusJob extends BaseCronJob {
    ...
    public void execute() {
        ...
        String xmbsql = "select id,requestId,xmbh,xmmc,htrq,mbcb,formmodeid,modedatacreater,modedatacreatertype," +
        ...
        String xmbyhs = "insert into uf_xmbyhs " +
                "(requestId,xmbh,xmmc,htrq,mbcb,formmodeid,modedatacreater,modedatacreatertype," +
        ...
        while(xmbRec.next()) {
            ...
            xmbyhsList.add(Util.null2String(xmbRec.getString("formmodeid")));
            ...
            xmbArr[0] = 2;
            xmbArr[1] = Util.null2String(xmbRec.getString("id"));
            xmbyhsRec.executeUpdate(xmbUpdateSql,xmbArr);
        }
